...
export class Create1766751780963 implements MigrationInterface {
    name = 'Create1766751780963'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`attendance\` DROP COLUMN \`data\``);
        await queryRunner.query(`ALTER TABLE \`attendance\` ADD \`data\` json NULL`);
        await queryRunner.query(`ALTER TABLE \`attendance\` CHANGE \`user_id\` \`user_id\` int NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`plans\` DROP COLUMN \`featureIds\``);
        await queryRunner.query(`ALTER TABLE \`plans\` ADD \`featureIds\` json NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX \`IDX_163c1af1ae33bd15ef6a9ad943\` ON \`reaction\``);
        await queryRunner.query(`ALTER TABLE \`plans\` DROP COLUMN \`featureIds\``);
        await queryRunner.query(`ALTER TABLE \`plans\` ADD \`featureIds\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        ...
        await queryRunner.query(`ALTER TABLE \`attendance\` CHANGE \`user_id\` \`user_id\` int NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`attendance\` DROP COLUMN \`data\``);
        await queryRunner.query(`ALTER TABLE \`attendance\` ADD \`data\` longtext COLLATE "utf8mb4_bin" NULL DEFAULT 'NULL'`);
        await queryRunner.query(`ALTER TABLE \`attendance\` ADD CONSTRAINT \`FK_0bedbcc8d5f9b9ec4979f519597\` FOREIGN KEY (\`user_id\`) REFERENCES \`users\`(\`id\`) ON DELETE CASCADE ON UPDATE NO ACTION`);
